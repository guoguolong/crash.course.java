...
<body>
<%--这里用jsp实现用户的添加功能--%>
<jsp:useBean id="users" scope="session" class="club.banyuan.bm.model.Users"></jsp:useBean>
...
<sql:update var="result" dataSource="${ds}">
    insert into users (name,loginname,userid) values ('${users.name}','${users.loginname}',${users.userid});
</sql:update>
